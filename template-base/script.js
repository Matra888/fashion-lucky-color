...
function showLearnMoreModal() {
    ...
    selectedColor.combinations.forEach(combo => {
        ...
        comboDiv.appendChild(colorsDiv);
        comboDiv.appendChild(nameDiv);
        comboDiv.appendChild(descDiv);
        colorCombinations.appendChild(comboDiv);
    });
    
    // Add "Find Your Personalized Palette" button
    const paletteButton = document.createElement('a');
    paletteButton.href = 'https://form.typeform.com/to/XMX7vBNh';
    paletteButton.target = '_blank';
    paletteButton.className = 'quiz-button';
    paletteButton.style.display = 'inline-block';
    paletteButton.style.marginTop = '25px';
    paletteButton.textContent = 'Find Your Personalized Palette';
    colorCombinations.appendChild(paletteButton);
